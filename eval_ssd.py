...
parser.add_argument(
    "--dataset_type", default="voc", type=str, help="Specify dataset type. Currently support voc and open_images."
)
...
def compute_average_precision_per_class(
    num_true_cases, gt_boxes, difficult_cases, prediction_file, iou_threshold, use_2007_metric
):
    ...
    for class_index, class_name in enumerate(class_names):
        ...
        with open(prediction_path, "w") as f:
            ...
            for i in range(sub.size(0)):
                ...
                print(image_id + "\t" + " ".join([str(v) for v in prob_box]).replace(" ", "\t"), file=f)
    aps = []
